...
LiveWidgets.addWidget({
        ...
        controller: {
				...
				showArtifact: function (artifact) {
					...
					'<tr><th>Issue Tracker</th><td>',
						'<a href="' + artifact.issueTracking + '">' + artifact.issueTracking + '</a>',
					'</td></tr>',
					'</table>',
					'</div>',
					...
					'<div data-widget="markdown-viewer" data-group="create-readme" data-inlets="readme" class="markdown-viewer"></div>',
					].join("");
